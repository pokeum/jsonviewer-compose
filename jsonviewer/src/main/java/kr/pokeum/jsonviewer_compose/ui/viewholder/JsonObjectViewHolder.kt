...
import kr.pokeum.jsonviewer_compose.ui.provider.JsonObjectProvider
...
@Composable
internal fun JsonObjectViewHolder(
    @PreviewParameter(JsonObjectProvider::class)
    target: JsonObject
) {
    ...
    ConstraintLayout(
        ...
        ConstraintLayout(
            ...
            Box(
                ...
                Text(
                    text = Strings.JSON_OBJECT_KEY_DESCRIPTION_LABEL,
